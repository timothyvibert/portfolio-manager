...
# V1 reads the holdings extract (`adw_extract_YYYYMMDD_HHMMSS.xlsx`) discovered by
# `pm.ingest.adw_loader.find_latest_adw_extract`. There is no single
# canonical filename anymore.
ADW_DATA_DIR = DATA_DIR
