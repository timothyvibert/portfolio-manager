...
def build_positions_columns() -> list[dict]:
    ...
    return [
        {"field": "type", "headerName": "Type", "width": 72, "filter": True},
        {"field": "underlying", "headerName": "Ticker", "width": 92,
         "filter": True, "cellClass": "blotter-ticker-cell",
        ...
        {"field": "position_label", "headerName": "Position", "width": 180,
         "filter": True, "tooltipField": "position_label", "cellClass": "dd-cell-ellipsis"},
        ...
        {"field": "position_size_pct", "headerName": "% NAV", "width": 84,
         "type": "rightAligned", "valueFormatter": PCT_ABS_FMT},
        {"field": "pnl", "headerName": "Unreal P&L", "width": 116,
         "type": "rightAligned", "valueFormatter": MONEY_FULL_FMT, "cellStyle": SIGNED_COLOR_STYLE},
        {"field": "pnl_pct", "headerName": "P&L %", "width": 84,
         "type": "rightAligned", "valueFormatter": PCT_SIGNED_FMT, "cellStyle": SIGNED_COLOR_STYLE},
